...
val Tertiary = Color(0xFF00B0FF)
val Neutral = Color(0xFF1C1B1F)

val PrimaryLight = Color(0xFF534BAE)
val PrimaryDark = Color(0xFF000051)

val SecondaryLight = Color(0xFF60AD5E)
val SecondaryDark = Color(0xFF005005)

val Surface = Color(0xFFFBFBFF)
val Background = Color(0xFFFBFBFF)
